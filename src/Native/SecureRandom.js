var _openirc$elm_crypto$Native_SecureRandom = function() {
'use strict';
    ...
    return _elm_lang$core$Native_Scheduler.nativeBinding(function(callback) {
      callback(
        _elm_lang$core$Native_Scheduler.fail(
          _openirc$elm_crypto$Random_Secure$NoGetRandomValues
        )
      );
    });
  }
  ...
  return function(count) {
    return _elm_lang$core$Native_Scheduler.nativeBinding(function(callback) {
      ...
      try {
        ...
        callback(
          _elm_lang$core$Native_Scheduler.fail(
            A2(_openirc$elm_crypto$Random_Secure$Exception, errorName, errorMessage)
          )
        );
        return;
      }
